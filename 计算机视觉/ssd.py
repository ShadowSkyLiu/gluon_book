...
# root_url = ('https://apache-mxnet.s3.cn-north-1.amazonaws.com.cn/'
#             'gluon/dataset/pikachu/')
# data_dir = '~/.mxnet/datasets/data/pikachu/'
...
class ToySSD(gluon.Block):
    def __init__(self, num_classes, verbose=False, **kwargs):
        ...
        self.sizes = [
            [.2, .272], [.37, .447], [.54, .619], [.71, .79], [.88, .961]]
        self.ratios = [[1, 2, .5]] * 5
...
class FocalLoss(gluon.loss.Loss):
    ...
    def hybrid_forward(self, F, x, output, label):
